...
> ```
> /team-kit-run  — execute the approved plan: mode-1 AUTHORS plan.workflow.js from team-plan.md (native), lints + saves it, then runs it (or mode-2 ad-hoc for one-offs)
> ```
