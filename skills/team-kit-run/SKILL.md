...
- **Model tiering IS the cost lever** — `opts.model:'sonnet'` on mechanical/review/finalize stages; reserve inherited opus for implement/design (rule 13). There is no cache-sharing lever on the workflow path.
...
```
prompt.md  requirements.md  design.md  team-plan.md  definition-of-done.md
```
