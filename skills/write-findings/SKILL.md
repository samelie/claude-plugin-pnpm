...
- Write denied by the harness subagent write guard (`findings*`/`report*` basenames) → write-denial protocol (`team-session-writing`): return the complete content as your final text + state the denial; the lead persists it
