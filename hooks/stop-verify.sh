...
# Relay-driven headless sessions (discord hitl): ending the turn IS the yield
# back to the human — blocking it would trap the session. Relay owns completion.
if [ "${HITL_RELAY:-}" = "1" ]; then
